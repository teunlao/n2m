...
export type FormErrors<T extends ReadyFieldsGroupSchema | PrimitiveValue> = T extends ReadyFieldsGroupSchema
  ? {
      [K in keyof T]: T[K] extends PrimitiveField<any>
        ? FieldError
...
> = {
  ...
  clearErrors: EventCallable<void>
  clearForm: EventCallable<void>
  ...
  validatedAndSubmitted: EventCallable<Values>
