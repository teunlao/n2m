import { arrayFieldSymbol, primitiveFieldSymbol, ReadyFieldsGroupSchema } from '../../../fields'
  ...
  for (const key in currentNode) {
    ...
    switch (subNode.type) {
      ...
      default: {
        ...
        map.call(this, subNode as ReadyFieldsGroupSchema, resultValuesNode[key], resultErrorsNode[key], [...path, key])
