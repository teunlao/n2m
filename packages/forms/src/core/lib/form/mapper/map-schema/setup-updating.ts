...
import { FieldInteractionEventPayload, FieldInteractionEventPayloadBase } from './types'

export function setupUpdating() {
  const schemaUpdated = createEvent<FieldInteractionEventPayload>('<schema updated>')
