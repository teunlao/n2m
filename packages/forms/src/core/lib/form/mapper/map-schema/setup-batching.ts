...
import { BatchedSchemaUpdatedPayload, FieldInteractionEventPayload } from './types'
import { getCompletedBatchTasks } from '../../batching'

export function setupBatching(schemaUpdated: EventCallable<FieldInteractionEventPayload>) {
