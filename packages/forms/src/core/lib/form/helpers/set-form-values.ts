...
export function setFormValues<Values>(values: Values, formApi: FormApi, addBatchTask: EventCallable<BatchInfo>) {
  const iteratedValues: Record<string, { event: FormApi[string]['batchedSetValue']; value: any }> = {}
