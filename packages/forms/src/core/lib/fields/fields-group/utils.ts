...
import type { AnySchema, ReadyFieldsGroupSchema, UserFormSchema } from './types'

export function prepareFieldsSchema<T extends AnySchema | PrimitiveValue, U = UserFormSchema<T>>(schema: T): U {
