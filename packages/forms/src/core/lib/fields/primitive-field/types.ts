...
export type PrimitiveValue = bigint | PrimitiveJsonValue | Blob | ArrayBuffer | File | FileList
...
export interface PrimitiveField<T extends PrimitiveValue = any> extends PrimitiveFieldApi<T> {
  ...
  '@@unitShape': () => {
    ...
    change: EventCallable<T>
    changeError: EventCallable<FieldError>
    clearInnerError: EventCallable<void>
  }
}
