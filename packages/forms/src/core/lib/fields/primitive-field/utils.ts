...
export function isPrimitiveJsonValue(props: any): props is PrimitiveJsonValue {
  return typeof props === 'boolean' || typeof props === 'string' || typeof props === 'number'
}
...
export function isPrimitiveValue(props: any): props is PrimitiveValue {
  ...
  const isBuffer = typeof Buffer !== 'undefined' ? props instanceof Buffer : false
  const isFileList = typeof FileList !== 'undefined' ? props instanceof FileList : false
