import { createEvent, createStore, Event, EventAsReturnType, EventCallable, sample } from 'effector'
...
export function inOrder<P extends any[]>(events: Events<P>): EventAsReturnType<P> {
