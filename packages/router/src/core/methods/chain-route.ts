...
import { RouteInstance, RouteInstanceInternal, RouteParams, RouteParamsAndQuery, RouteQuery } from '../types'
...
function chainRoute<Params extends RouteParams>(instance: RouteInstance<Params>): RouteInstance<Params>

function chainRoute<Params extends RouteParams>(config: ChainRouteParamsWithEffect<Params>): RouteInstance<Params>

function chainRoute<Params extends RouteParams>(config: ChainRouteParamsAdvanced<Params>): RouteInstance<Params>
...
function normalizeChainRouteParams<Params extends RouteParams, FX extends Effect<any, any, any>>(
  ...
  Object.assign(resultParams, {
    ...
    beforeOpen: is.unit(effectParams.beforeOpen) ? effectParams.beforeOpen : attach(effectParams.beforeOpen),
  })
