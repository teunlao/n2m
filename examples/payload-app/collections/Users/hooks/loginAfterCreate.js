...
var loginAfterCreate = function (_a) {
    var doc = _a.doc, operation = _a.operation, req = _a.req, _b = _a.req, _c = _b.body, body = _c === void 0 ? {} : _c, payload = _b.payload, res = _b.res;
    return __awaiter(void 0, void 0, void 0, function () {
        var email, password, _d, token, user;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    _d = _e.sent(), token = _d.token, user = _d.user;
