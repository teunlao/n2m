    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                // Seed database with startup data
                jobs_1.resetScheduledJob.start();
                app.listen(PORT, function () {
                    payload_1.default.logger.info("App URL: ".concat(process.env.PAYLOAD_PUBLIC_SERVER_URL));
                });
                return [2 /*return*/];
        }
    });
